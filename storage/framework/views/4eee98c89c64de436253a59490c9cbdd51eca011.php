<?php /* D:\0 - Zulkipli Bin Suhib\Project_Zulkipli\resources\views/layouts/app.blade.php */ ?>
<!DOCTYPE html>
        ...
        <nav class="navbar navbar-expand-md navbar-laravel bg-dark navbar-dark">
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <!-- Left Side Of Navbar -->
                      <a href="<?php echo e(route('products.index')); ?>" class="nav-link text-light"  role="button">All Products</a>
