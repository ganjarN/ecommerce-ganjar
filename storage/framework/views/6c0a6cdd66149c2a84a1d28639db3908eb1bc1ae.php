<?php /* C:\Users\Ganjar\Downloads\uas pak dadan\ecommerce_Ganjar\resources\views/admin/orders/show.blade.php */ ?>
      ...
      <div class="row justify-content-center">
        ...
        <div class="row">
          <div class="col">
            ...
            <p><?php echo e($order->total_price); ?></p>
          </div>
        </div>
      </div>
                  ...
                  <td data-th="Product">
                    <div class="row">
                      <div class="col-sm-3 hidden-xs">
                        ...
                        <img src="<?php echo e(url('/image_files/'.$orderItem->product->image_url)); ?>" width="100" height="100" class="img-responsive">
                      </div>
                      <div class="col-md-9">
